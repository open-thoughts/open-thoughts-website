...
We are just getting started. A new field of exciting research has just opened up. If you want to contribute or sponsor the Open Thoughts effort, please [get in touch](mailto:hello@open-thoughts.ai) or raise an issue on [GitHub](https://github.com/open-thoughts/open-thoughts). Come and join us on this journey!
