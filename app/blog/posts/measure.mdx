...
If you can't measure, you can't improve it. At [Open Thoughts](https://github.com/open-thoughts/open-thoughts), we are on a mission to build the best [open reasoning datasets](https://huggingface.co/open-thoughts) (and therefore, the best open reasoning models). We are sharing everything publicly on our journey including the tools we are using to get there. Today we are releasing reasoning benchmarks into our model evaluation tool [Evalchemy](https://github.com/mlfoundations/evalchemy). 
...
<Table
  data={{
    ...
    rows: [
      ...
      ["Evalchemy Eval", "gpt-4o-0513", "10.0", "75.8", "46.5"],
