...
summary: 'As part of the OpenThoughts project, we have added common reasoning benchmarks into Evalchemy.'
---

If you can't measure it, you can't improve it. At [OpenThoughts](https://github.com/open-thoughts/open-thoughts), we are on a mission to build the best [open reasoning datasets](https://huggingface.co/open-thoughts) (and therefore, the best open reasoning models). We are sharing everything publicly on our journey including the tools we are using to get there. Today we are releasing reasoning benchmarks into our model evaluation tool [Evalchemy](https://github.com/mlfoundations/evalchemy). 
