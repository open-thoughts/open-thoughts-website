...
The additional metadata will make it easier to use this dataset in new ways: filtering, swapping out domains, checking verification, changing the reasoning trace templating, etc. 
