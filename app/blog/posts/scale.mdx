...
All reported numbers are computed using our open source evaluation framework [Evalchemy](https://github.com/mlfoundations/evalchemy). Note that DeepSeek-R1-Distill-Qwen-32B is a closed data model, with a reported 800k dataset size with 600k reasoning samples.
