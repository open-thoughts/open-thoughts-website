...
---
Today, we are releasing [OpenThoughts3](https://huggingface.co/datasets/open-thoughts/OpenThoughts3), a new state of the art open-data reasoning dataset. Along with the dataset, we provide a new model [OpenThinker3](https://huggingface.co/open-thoughts/OpenThinker3) that is simply trained with SFT on our curated data.
<Table
  data={{
    headers: [
      "Model",
