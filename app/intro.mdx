...
Our **latest release** is [OpenThoughts3](https://openthoughts.ai/ot3), the new SOTA open reasoning data recipe. Read the [blog](https://openthoughts.ai/blog/ot3) and the full [paper](https://arxiv.org/pdf/2506.04178) for more detail! 
