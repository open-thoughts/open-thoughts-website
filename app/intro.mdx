...
A [Bespoke Labs](https://bespokelabs.ai/) and [DataComp](https://www.datacomp.ai/) community effort to curate the best open reasoning datasets.
...
<Table
  data={{
    ...
    rows: [
      ...
      ["[Bespoke-Stratos-7B](https://huggingface.co/bespokelabs/Bespoke-Stratos-7B)", "22.7", "79.6", "38.9", "71.4", "25.2", "0.8"],
      ["[DeepSeek-R1-Distill-Qwen-7B](https://huggingface.co/deepseek-ai/DeepSeek-R1-Distill-Qwen-7B)", "60.0", "88.2", "46.9", "79.7", "45.1", "14.6"],
